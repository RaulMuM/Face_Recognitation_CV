...
def registrar_usuario():
    usuario_info = usuario.get() #Obtenemos la informacion alamcenada en usuario
...
def pantalla_principal():
    ...
    pantalla.title("Proyecto CV - Reconocimiento Facial")       #Asignamos el titulo de la pantalla
